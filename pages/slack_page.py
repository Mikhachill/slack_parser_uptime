...
class SlackPage(BasePage):
    ...
    def data_for_pars(self):
        ...
        for i in itertools.count():
            z+=1
            with open('debug.txt', 'a') as u: u.write('дошел до 95 ')            

            try:
                data = self.browser.find_element(By.XPATH,xpath+f"/div[{z}]")
                with open('debug.txt', 'a') as u: u.write('дошел до 99 ')            

                if data.get_attribute('innerHTML')=='Loading history...':
                    try:
                        self.browser.find_element(By.XPATH,xpath+f"/div[{z-1}]")
                        with open('debug.txt', 'a') as u: u.write('дошел до 104')            

                        z=0
                    except(NoSuchElementException):
                        iterator=0
                        with open('debug.txt', 'a') as u: u.write('дошел до 110')            
                        ...
                        with open('debug.txt', 'a') as u: u.write(f'дошел до 117 break,итератор {iterator}')            
                        ...
                        for i in itertools.count():
                            ...
                            iterator+=1             
                            with open('debug.txt', 'a') as u: u.write('дошел до 126')            
                            ...
                            if df=='Loading history...':
                                ...
                                with open('id.txt', 'a') as u: u.write(last_id+' ')            
                                ...
                                actions.perform() 
                                z=0
                                with open('debug.txt', 'a') as u: u.write('дошел до 140 break')            
                                break
                                

                                                                    
                            else:
                                with open('slack.html', 'a') as output_file: output_file.write(df)
                        ...
                        z=0                
                        with open('debug.txt', 'a') as u: u.write('дошел до 150 основной except')            
