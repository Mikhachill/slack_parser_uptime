...
class SlackPageLocators():
    ...
    JANUARY=(By.CSS_SELECTOR,"button.c-button-unstyled.c-button-unstyled.c-mini_calendar__month_button.c-mini_calendar__month_1")
    ...
    DATA_XPATH=(By.XPATH, "//div[@class='c-virtual_list c-virtual_list--scrollbar c-message_list c-scrollbar c-scrollbar--fade']/div/div/div[@data-qa='slack_kit_list']/div[4]")
